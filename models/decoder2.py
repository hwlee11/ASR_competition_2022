...
def greedy_decode():
    ...
    batch_size, seq_len = 1,50#target_tensor.size()
    ...
    decoder_output = torch.rand(2,2000,50)
...
def main():
    data = torch.rand(2000,30)
    #sequences = beamSearchDecoder(data,5)
    #sequences = beam_decode(data,5)
